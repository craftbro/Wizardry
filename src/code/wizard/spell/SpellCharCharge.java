...
public class SpellCharCharge extends Spell{

	public SpellCharCharge(Player p) {
		super(p);
		
		name = ChatColor.GRAY+"Char Charge";
		stack = new ItemStack(Material.COAL, 1, (byte)1);
		cost = 40;
		
		des.add(ChatColor.DARK_AQUA+"Fires a bomb that on impact, deals");
		des.add(ChatColor.WHITE+"35 "+ChatColor.DARK_GRAY+"Dark "+ChatColor.DARK_AQUA+"damage to enemies");
	...
	@Override
	public void cast(){
final ProjectileBall ball = new ProjectileBall(new ItemStack(Material.COAL, 1, (byte)1));
